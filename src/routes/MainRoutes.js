...
const DashboardProfile = Loadable(lazy(() => import('views/dashboard/Dashboards')));
const DashboardListUser = Loadable(lazy(() => import('views/dashboard/Dashboards')));
const DashboardAddUser = Loadable(lazy(() => import('views/dashboard/Dashboards')));
const SampleProgram = Loadable(lazy(() => import('views/dashboard/Chart/sample')));

// Chart Routing
const ChartDemo = Loadable(lazy(() => import('views/dashboard/Chart')));
...
const MainRoutes = {
    ...
    children: [
        ...
        {
            path: '/dashboard/profiles/userlist',
            element: <DashboardListUser />
        },
        {
            path: '/dashboard/profiles/adduser',
            element: <DashboardAddUser />
        },
        {
            path: '/sampless',
            element: <SampleProgram />
        }
    ]
};
